...
<body>
	...
	<%
	    ...
	    List<UprodVO> list = uprodSvc.getAllByCustomer(memVO.getMemNo());
                ...
                <div class="col-lg-12">
                    ...
                    <div class="cart-table" style="margin-top: 20px; width: 1100px;">
                        <table>
                            ...
                            <tbody>
                                <tr>
									...
									<td class="qua-col first-row" style="width:80px; text-align: center;">
                                    	<c:if test="${uprodVO.receiveStatus=='RS0'}">尚未收到貨</c:if>
                                    	<c:if test="${uprodVO.receiveStatus=='RS1'}">已領收商品</c:if>
									</td>
									<td class="qua-col first-row" style="width:120px; text-align: center;">
                        ...
                        <div style="text-align: center; margin-top: 20px;">
                        	<c:if test="${list.size()==0}">您沒有購買任何商品</c:if>
                        </div>
                    </div>
