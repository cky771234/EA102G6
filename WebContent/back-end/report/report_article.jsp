...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800" style="margin-top: 35px; font-weight:bold;">文章檢舉審核</h1>
...
<!-- 												  </td> -->
							                      ...
							                      <td>
							                      	<c:if test="${reparticleVO.repstatus=='R0'}"><h6>未處理</h6></c:if>
							                      	<c:if test="${reparticleVO.repstatus=='R1'}"><h6>檢舉通過</h6></c:if>
							                      	<c:if test="${reparticleVO.repstatus=='R2'}"><h6>檢舉未通過</h6></c:if>
							                      </td>
							                      <td>
...
<!-- 												  </td> -->
							                      ...
							                      <td>
							                      	<c:if test="${represponseVO.repstatus=='R0'}"><h6>未處理</h6></c:if>
							                      	<c:if test="${represponseVO.repstatus=='R1'}"><h6>檢舉通過</h6></c:if>
							                      	<c:if test="${represponseVO.repstatus=='R2'}"><h6>檢舉未通過</h6></c:if>
							                      </td>
							                      <td>
							                      	<button type="button" class="btn btn-primary"
															data-toggle="modal"
