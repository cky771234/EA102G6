		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav
					...
					<h1 class="h3 mb-2 text-gray-800">員工個人資料修改</h1>
...
<script>
				...
				function() {
					...
					$.ajax({
						...
						success : function(res) {
							if (res == 'true') {
								$("#changeForm td[name='empid']").html("帳號重複");
							}
	...
	function checkReg(obj) {
		...
		if ($("#changeForm input[name='empemail']").val().trim() == "") {
			$("#changeForm td[name='empemail']").html('請勿空白');
		} else {
			...
			if ($("#changeForm input[name='empemail']").val().search(emailRule) != -1) {
				...
				$("#changeForm td[name='empemail']").html('請填寫為EMAIL格式');
			}
		}
